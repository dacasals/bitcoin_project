...
charlie_hashed_pubkey = codecs.encode(base58.b58decode_check(Charlie_adr)[1:], 'hex_codec')
...
rtx.tx_out1["pk_script"] 	= bytes.fromhex(('76a914{}88ac'.format(charlie_hashed_pubkey.decode("utf-8"))))
rtx.tx_out1["pk_script_bytes"] = struct.pack("<B", len(rtx.tx_out1["pk_script"]))

rtx.tx_out2["value"]		= struct.pack("<Q", 50000)
rtx.tx_out2["pk_script"] 	= bytes.fromhex(('76a914{}88ac'.format(bob_hashed_pubkey.decode("utf-8"))))
